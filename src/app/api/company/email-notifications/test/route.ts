...
import { resolveNotificationEmails, loadCompanyEmailSettings } from "@/lib/email-notifications/dispatch";
...
export async function POST(request: NextRequest) {
  ...
  const recipients = await resolveNotificationEmails(db, companyId, loaded);
